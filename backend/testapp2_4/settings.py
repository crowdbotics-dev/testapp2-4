"""
Django settings for testapp2_4 project.
...
WSGI_APPLICATION = 'testapp2_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp2_4 API",
    "DESCRIPTION": "API documentation for testapp2_4 App",
    "VERSION": "v1",
}
